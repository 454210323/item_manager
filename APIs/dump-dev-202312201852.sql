...
CREATE TABLE `extra_expense` (
  ...
  `expense_content` varchar(255) DEFAULT NULL,
...
INSERT INTO `extra_expense` VALUES (1,'电车',600,'一日券','2023-12-08');
...
INSERT INTO `item` VALUES ('123456789','test','type','series',1000),('4902070700117','cafe','饮料','日常',160),('4909411091361','午后红茶','饮料','日常',180),('4974413848640','龙龙','迷你公仔','角落生物',1600);
...
CREATE TABLE `shipment` (
  ...
  `recipient` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stock` VALUES (1,'4902070700117',2,'2023-12-18 20:37:13'),(2,'4909411091361',1,'2023-12-18 22:23:10');
...
-- Dump completed on 2023-12-20 18:52:08
